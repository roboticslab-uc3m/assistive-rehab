...
const string eye_left="eyeLeft";
const string ear_left="earLeft";
const string eye_right="eyeRight";
const string ear_right="earRight";
const string wrist_left="wristLeft";
const string abductor_left="abductorLeft";
const string thumb_base_left="thumbBaseLeft";
const string thumb_proximal_left="thumbProximalLeft";
const string thumb_distal_left="thumbDistalLeft";
const string index_base_left="indexBaseLeft";
const string index_proximal_left="indexProximalLeft";
const string index_intermediate_left="indexIntermediateLeft";
const string index_distal_left="indexDistalLeft";
const string middle_base_left="middleBaseLeft";
const string middle_proximal_left="middleProximalLeft";
const string middle_intermediate_left="middleIntermediateLeft";
const string middle_distal_left="middleDistalLeft";
const string ring_base_left="ringBaseLeft";
const string ring_proximal_left="ringProximalLeft";
const string ring_intermediate_left="ringIntermediateLeft";
const string ring_distal_left="ringDistalLeft";
const string pinky_base_left="pinkyBaseLeft";
const string pinky_proximal_left="pinkyProximalLeft";
const string pinky_intermediate_left="pinkyIntermediateLeft";
const string pinky_distal_left="pinkyDistalLeft";
const string wrist_right="wristRight";
const string abductor_right="abductorRight";
const string thumb_base_right="thumbBaseRight";
const string thumb_proximal_right="thumbProximalRight";
const string thumb_distal_right="thumbDistalRight";
const string index_base_right="indexBaseRight";
const string index_proximal_right="indexProximalRight";
const string index_intermediate_right="indexIntermediateRight";
const string index_distal_right="indexDistalRight";
const string middle_base_right="middleBaseRight";
const string middle_proximal_right="middleProximalRight";
const string middle_intermediate_right="middleIntermediateRight";
const string middle_distal_right="middleDistalRight";
const string ring_base_right="ringBaseRight";
const string ring_proximal_right="ringProximalRight";
const string ring_intermediate_right="ringIntermediateRight";
const string ring_distal_right="ringDistalRight";
const string pinky_base_right="pinkyBaseRight";
const string pinky_proximal_right="pinkyProximalRight";
const string pinky_intermediate_right="pinkyIntermediateRight";
const string pinky_distal_right="pinkyDistalRight";
}
