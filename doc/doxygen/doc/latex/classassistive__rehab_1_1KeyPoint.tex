...
\begin{DoxyCode}{0}
\DoxyCodeLine{101 \{}
\DoxyCodeLine{102     \textcolor{keywordflow}{return} ((i>=0) \&\& (i<child.size()))?child[i]:\textcolor{keyword}{nullptr};}
\DoxyCodeLine{103 \}}
...
\subsubsection{\texorpdfstring{getNumChild()}{getNumChild()}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{208 \{ \textcolor{keywordflow}{return} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int})child.size(); \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{195 \{ \textcolor{keywordflow}{return} (\textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int})parent.size(); \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{96 \{}
\DoxyCodeLine{97     \textcolor{keywordflow}{return} ((i>=0) \&\& (i<parent.size()))?parent[i]:\textcolor{keyword}{nullptr};}
\DoxyCodeLine{98 \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{189 \{ \textcolor{keywordflow}{return} pixel; \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{164 \{ \textcolor{keywordflow}{return} point; \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{156 \{ \textcolor{keywordflow}{return} tag; \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{150 \{ \textcolor{keywordflow}{return} updated; \}}
