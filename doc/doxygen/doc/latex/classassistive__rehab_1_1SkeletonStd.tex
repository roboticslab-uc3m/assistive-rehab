...
Definition at line 531 of file skeleton.\+h.
...
Reimplemented in \mbox{\hyperlink{classassistive__rehab_1_1SkeletonWaist_aee15b1accdf628b18dac2a372597644a}{assistive\+\_\+rehab\+::\+Skeleton\+Waist}}.



Definition at line 747 of file skeleton.\+cpp.


\begin{DoxyCode}{0}
\DoxyCodeLine{748 \{}
\DoxyCodeLine{749     \textcolor{keywordtype}{int} cnt=0;}
\DoxyCodeLine{750     \textcolor{keywordflow}{if} (tag2key[KeyPointTag::shoulder\_left]->isUpdated() \&\&}
\DoxyCodeLine{751         tag2key[KeyPointTag::shoulder\_right]->isUpdated())}
\DoxyCodeLine{752     \{}
\DoxyCodeLine{753         sagittal=tag2key[KeyPointTag::shoulder\_left]->getPoint()-}
\DoxyCodeLine{754                  tag2key[KeyPointTag::shoulder\_right]->getPoint();}
\DoxyCodeLine{755         \textcolor{keywordtype}{double} n=norm(sagittal);}
\DoxyCodeLine{756         \textcolor{keywordflow}{if} (n>0.0)}
\DoxyCodeLine{757             sagittal/=n;}
\DoxyCodeLine{758         cnt++;}
\DoxyCodeLine{759     \}}
\DoxyCodeLine{760 }
\DoxyCodeLine{761     \textcolor{keywordflow}{if} (tag2key[KeyPointTag::shoulder\_center]->isUpdated() \&\&}
\DoxyCodeLine{762         tag2key[KeyPointTag::hip\_left]->isUpdated() \&\&}
\DoxyCodeLine{763         tag2key[KeyPointTag::hip\_right]->isUpdated())}
\DoxyCodeLine{764     \{}
\DoxyCodeLine{765         transverse=tag2key[KeyPointTag::shoulder\_center]->getPoint()-}
\DoxyCodeLine{766                    0.5*(tag2key[KeyPointTag::hip\_left]->getPoint()+}
\DoxyCodeLine{767                         tag2key[KeyPointTag::hip\_right]->getPoint());}
\DoxyCodeLine{768         \textcolor{keywordtype}{double} n=norm(transverse);}
\DoxyCodeLine{769         \textcolor{keywordflow}{if} (n>0.0)}
\DoxyCodeLine{770             transverse/=n;}
\DoxyCodeLine{771         cnt++;}
\DoxyCodeLine{772     \}}
\DoxyCodeLine{773 }
\DoxyCodeLine{774     coronal=cross(sagittal,transverse);}
\DoxyCodeLine{775     \textcolor{keywordflow}{return} (cnt>=2);}
\DoxyCodeLine{776 \}}
